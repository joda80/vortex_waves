...
# Less accurate but good enough to get an idea:
...
eps = 0.005 # 1.E-3 This value will depend on the resolution (nmax)
...
#              oi_arr[nk] = ppy
              print('')
              print('S ', 'step ', 'k ', 'omega_r ', 'omega_i ', S, nk, k, ppx, ppy)
